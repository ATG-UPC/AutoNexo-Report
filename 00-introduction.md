...
- [ **Capítulo IV: Product Implementation & Validation** ](#-capítulo-iv-product-implementation-&-validation )
  ...
  - [**4.2. Landing Page, Services & Mobile Implementation**](#42-landing-page-services-mobile-implementation)
    ...
    - [**4.2.2. Sprint 2**](#421-sprint-1)
      - [**4.2.2.1. Sprint Planning 2**](#4211-sprint-planning-1)
      - [**4.2.2.2. Sprint Backlog 2**](#4212-sprint-backlog)
...
<td style="border-color:black;border-style:solid;border-width:1px;font-family:Arial, sans-serif;font-size:14px;overflow:hidden;padding:10px 5px;text-align:left;vertical-align:top;word-break:normal">TB1: <br> Como grupo, actualizamos y fortalecimos nuestros conocimientos en metodologías ágiles, diseño de experiencia de usuario y arquitectura de software en diferentes niveles. Cada integrante aplicó conceptos actualizados que permitieron enriquecer el proyecto y avanzar en una solución más profesional y estructurada. <br><br>TP1: <br> Como grupo, actualizamos y fortalecimos nuestros conocimientos en metodologías ágiles, diseño de experiencia de usuario y arquitectura de software en distintos niveles. Cada integrante aplicó conceptos actualizados que permitieron enriquecer el proyecto y avanzar hacia una solución más profesional, estructurada y alineada con las buenas prácticas de la ingeniería de software. <br> <br> TB2: Como grupo, actualizamos nuestros conocimientos en desarrollo móvil, backend y gestión de documentación técnica. La combinación de avances en Kotlin, Dart, Spring Java y la corrección de entregables permitió reforzar habilidades clave en construcción de aplicaciones completas, despliegue y control de versiones. Esta entrega fortaleció nuestra capacidad de aplicar conceptos actualizados para avanzar de forma sólida en la solución de ingeniería propuesta. <br> <br> Andres Cruz:</b> <br> TB2: <br> Al avanzar en las pantallas de la aplicación móvil en Kotlin y corregir observaciones del reporte y la presentación, actualicé mis conocimientos en desarrollo móvil nativo, estructuración de UI y buenas prácticas de documentación técnica, fortaleciendo mi capacidad para construir interfaces funcionales y alineadas al diseño del proyecto. <br><b> Angelo Solano: </b><br> TB2: <br> Al avanzar en pantallas tanto en Kotlin como en Dart, actualicé mis conocimientos en desarrollo multiplataforma, diseño responsivo y consistencia visual entre entornos. La documentación del Sprint 2 reforzó mi comprensión sobre la comunicación técnica en proyectos reales. <b> Henry Esteban: </b> <br> TB2: <br> Al registrar las versiones de la TB2, corregir las observaciones del reporte y presentación y participar en la documentación del Sprint 2, actualicé mis conocimientos en control de versiones, gestión de entregables e integración de documentación técnica, reforzando habilidades esenciales para el desarrollo profesional en ingeniería de software. <b> Rafael Vivanco:</b><br> TB2: <br> Al avanzar en las pantallas de la aplicación móvil en Kotlin y corregir observaciones del reporte y la presentación, actualicé mis conocimientos en desarrollo móvil nativo, estructuración de UI y buenas prácticas de documentación técnica, fortaleciendo mi capacidad para construir interfaces funcionales y alineadas al diseño del proyecto. <br><b> Sergio Iglesias </b><br> TB2: <br> Con la implementación y despliegue del backend en Spring Java, actualicé mis conocimientos en arquitectura backend, servicios REST, configuración de entornos y despliegue de aplicaciones, fortaleciendo mis competencias en desarrollo de software escalable y mantenible. </td>
</tr>
...
<div>
  <p><img alt="Contributors TB2" src="assets\chapter-IV-assets\sprint2_evidence_participation_backend.png" width="700px"/></p>
</div>

Backend:
<div>
  <p><img alt="Contributors TB2" src="assets\chapter-IV-assets\sprint2_evidence_participation_report.png" width="700px"/></p>
</div>
